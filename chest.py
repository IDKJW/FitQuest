'''Import Modules
This is the chest excerise page for the user to train their chest'''
...
class ChestExerciseApp:
    '''Class represent ChestExerciseaApp'''

    def __init__(self):
        # Create the main application window
        self.root = tk.Tk()
        self.root.title("Chest Exercise")
    ...
    def home(self):
        '''Destory chest GUI and then import home GUI'''
        self.root.destroy()
