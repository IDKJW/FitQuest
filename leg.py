'''Import Modules
This is the leg excerise page for the user to train their legs'''
...
class LegExerciseApp:
    '''Class represent legExerciseaApp'''

    def __init__(self):
        # Create the main application window
        self.root = tk.Tk()
        self.root.title("leg Exercise")
        ...
        # Define image and output background image
    ...
    def home(self):
        '''Destory leg GUI and then import home GUI'''
        self.root.destroy()
