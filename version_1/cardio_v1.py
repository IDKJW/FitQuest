...
cardio = tk.Tk()
cardio.title("cardio Exercise")
cardio.geometry("500x800")
cardio.resizable(width=False, height=False)

# Create background image
background_image = PhotoImage(file="assets/Aim high.png")
background_label = Label(cardio, image=background_image)
...
exercise_label = tk.Label(cardio, text="Exercise:", background="black", fg="white")
exercise_label.pack()

reps_label = tk.Label(cardio, text="Reps", background="black", fg="white")
reps_label.pack()

# Create an empty label for the image
image_label = tk.Label(cardio, background="black")
image_label.pack()

# Create a button to generate random exercise
generate_button = tk.Button(cardio, text="Generate Exercise", command=generate_random_exercise, background="black", fg="black")
generate_button.pack()

# Create a label with clickable text
cardio_text_button = tk.Label(cardio, text="<-Back", fg="blue", cursor="hand2", background="black")
cardio_text_button.pack()

# Bind the click event to the label
cardio_text_button.bind("<Button-1>", text_clicked)
