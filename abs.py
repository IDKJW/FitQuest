'''Import Modules
This is the abs excerise page for the user to train their abs'''
...
class AbsExerciseApp:
    '''Class represent ABSExerciseaApp'''

    def __init__(self):
        # Create the main application window
        self.root = tk.Tk()
        self.root.title("Abs Exercise")
        ...
        cursor.execute("SELECT exercise, reps, image FROM Abs")
    ...
    def home(self):
        '''Destory abs GUI and then import home GUI'''
        self.root.destroy()
