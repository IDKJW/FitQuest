'''Import Modules
This is the back excerise page for the user to train their back'''
...
class BackExerciseApp:
    '''Class represent BackExerciseaApp'''

    def __init__(self):
        # Create the main application window
        self.root = tk.Tk()
        self.root.title("Back Exercise")
    ...
    def generate_random_exercise(self):
        ...
        if len(self.exercises_shown) == len(self.exercises):
            ...
            # Change the button text when all excerise has been output
            self.generate_button.config(text="Well Done")
            return
    ...
    def home(self):
        '''Destory back GUI and then import home GUI'''
        self.root.destroy()
