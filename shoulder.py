'''Import Modules
This is the shoulder excerise page for the user to train their shoulders'''
...
class ShoulderExerciseApp:
    '''Class represent shoulderExerciseaApp'''

    def __init__(self):
        # Create the main application window
        self.root = tk.Tk()
        self.root.title("shoulder Exercise")
        ...
        # Define the image and output it
    ...
    def generate_random_exercise(self):
        ...
        if len(self.exercises_shown) == len(self.exercises):
            ...
            self.generate_button.config(
                text="Well Done")
            # Change the button text when all the exercise has done
            return
    ...
    def home(self):
        '''Destory shoulder GUI and then import home GUI'''
        self.root.destroy()
