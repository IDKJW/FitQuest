'''Import Modules
This is the tricpes excerise page for the user to train their tricpes'''
...
class TricepsExerciseApp:
    '''Class represent tricepsExerciseaApp'''

    def __init__(self):
        # Create the main application window
        self.root = tk.Tk()
        self.root.title("Triceps Exercise")
        ...
        # Define background image and output it
        ...
        cursor.execute("SELECT exercise, reps, image FROM Triceps")
        ...
        self.canvas.create_window(
            250, 600, anchor="center", window=self.progress_bar)
        ...
        text_label = tk.Label(
            ...
            "\n4.Find a right weight for you to do these excerise"
            "\n5.Only do 3-4 excerise or you are going to over work yourself",
            bg="#4B9CD3",
            fg="black",
            wraplength=400,
    ...
    # Function for Generate random exercise
    ...
    def home(self):
        '''Destory triceps GUI and then import home GUI'''
        self.root.destroy()
