'''Import Modules
This is the bicep excerise page for the user to train their biceps'''
...
class BicepExerciseApp:
    '''Class represent BicepExerciseaApp'''

    def __init__(self):
        # Create the main application window
        self.root = tk.Tk()
        self.root.title("Bicep Exercise")
    ...
    # Function for randomly generate random exercise
    ...
    def home(self):
        '''Destory bicep GUI and then import home GUI'''
        self.root.destroy()
